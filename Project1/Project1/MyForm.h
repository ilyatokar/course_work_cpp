		...
		void InitializeComponent(void)
		{
			...
			this->магазиныToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->addedMagazinToolStripMenuItem,
					this->RemoveItemsSelectedToolStripMenuItem, this->listviewToolStripMenuItem, this->показать“оварыToolStripMenuItem, this->EditToolStripMenuItem
			});
			...
			this->экспортƒанных»з‘айлаToolStripMenuItem->Size = System::Drawing::Size(152, 20);
			this->экспортƒанных»з‘айлаToolStripMenuItem->Text = L"Ёкспорт данных из файла";
			// 
