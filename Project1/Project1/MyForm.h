		...
		void InitializeComponent(void)
		{
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(6) {
				this->òîâàğToolStripMenuItem,
					this->ProvidersToolStripMenuItem, this->documentToolStripMenuItem, this->ïğèõîäToolStripMenuItem, this->ğàñõîäToolStripMenuItem,
			...
			this->ïğèõîäToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::ComingToolStripMenuItem_Click);
			// 
